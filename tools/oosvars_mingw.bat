@set oos_path=F:\unix6\UNIX V6++V1\oos
@set mingw_path=F:\unix6\UNIX V6++V1\MinGW\bin
@set nasm_path=F:\unix6\UNIX V6++V1\NASM
@set bochs_path=F:\unix6\UNIX V6++V1\Bochs-2.6
